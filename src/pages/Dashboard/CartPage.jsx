      ...
      {cartItems.length === 0 ? (
        ...
        <>
          ...
          <div className="mt-6">
            ...
            <input type="url" placeholder="Paste image URL (e.g., https://imgur.com/xxx)" value={proofUrl} onChange={(e) => setProofUrl(e.target.value)} className="w-full px-4 py-2 bg-[#1e1b3a] text-white rounded" />

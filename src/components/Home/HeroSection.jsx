    ...
    <section className="relative bg-gradient-to-b from-[#0f0220] to-[#1a0333] text-white overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="flex-1">
          ...
          <p className="text-sm md:text-xl mb-8 text-gray-300">Discover and buy your favorite games now. From action, adventure, to simulation — everything is complete!</p>
        ...
        <div className="flex-1">
          <img src="/images/HeroImg.png" alt="Gamer Playing Game" className="w-full max-w-md mx-auto shadow-2xl" />
        </div>
      </div>

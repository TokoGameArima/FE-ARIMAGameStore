      ...
      <div className="max-w-7xl mx-auto px-6 py-20 flex flex-col md:flex-row items-center justify-between gap-10">
        <div className="flex-1">
          ...
          <div className="flex flex-wrap gap-4">
            <button onClick={() => navigate("/games")} className="w-full md:w-fit bg-gradient-to-r from-[#f93cff] to-[#ffa9f9] text-white px-6 py-3 rounded-full font-bold transition hover:opacity-90">
              Beli Sekarang
            </button>
